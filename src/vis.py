...
def network_analysis(output_file: str):
    ...
    ani.save(f"results/{output_file}_evolution.gif", writer="pillow", fps=1)
    print("Animation saved as upvote_evolution.")




def fused_network_visualisation(output_file: str):
    with open(f"data/{output_file}.json", 'r') as f:
        raw_data = json.load(f)
...
if __name__ == "__main__":
    network_analysis("gun_control_log")
    fused_network_visualisation("gun_control_log")